...
<head>
  ...
  <!-- Title -->
  <title>Nahorr Analytics | Website Template</title>
  ...
  <link rel="stylesheet" href="{{ asset('assets-admin/vendor/flatpickr/dist/css/flatpickr.min.css') }}">
  <link rel="stylesheet" href="{{ asset('assets-admin/vendor/bootstrap-select/css/bootstrap-select.min.css') }}">

  <link rel="stylesheet" href="{{ asset('assets-admin/vendor/chartist-js/chartist.min.css') }}">
  <link rel="stylesheet" href="{{ asset('assets-admin/vendor/chartist-js-tooltip/chartist-plugin-tooltip.css') }}">
...
<!-- JS Global Compulsory -->
  ...
  <script src="{{ asset('assets-admin/vendor/jquery-migrate/jquery-migrate.min.js') }}"></script>
  ...
  <script src="{{ asset('assets-admin/vendor/flatpickr/dist/js/flatpickr.min.js') }}"></script>
  ...
  <script src="{{ asset('assets-admin/vendor/chartist-js-tooltip/chartist-plugin-tooltip.js') }}"></script>
  <script src="{{ asset('assets-admin/vendor/fancybox/jquery.fancybox.min.js') }}"></script>
  ...
  <script src="{{ asset('assets-admin/js/components/hs.area-chart.js') }}"></script>
  <script src="{{ asset('assets-admin/js/components/hs.donut-chart.js') }}"></script>
  ...
  <script src="{{ asset('assets-admin/js/components/hs.popup.js') }}"></script>
