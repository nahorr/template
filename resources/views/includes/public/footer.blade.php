              ...
              <div class="row">
                <div class="col-lg-3">
                  <div class="footer-content">
                    <div class="logo-footer"><img id="logo-footer" src="{{ asset('tproject/images/logo_light_blue.png') }}" alt=""></div>
                ...
                <div class="col-lg-3">
                  <div class="footer-content">
                    ...
                    <div class="media margin-clear">
                      <div class="d-flex pr-2">
                        <div class="overlay-container">
                          <img class="media-object" src="{{ asset('tproject/images/blog-thumb-1.jpg') }}" alt="blog-thumb">
                    ...
                    <div class="media margin-clear">
                      <div class="d-flex pr-2">
                        <div class="overlay-container">
                          <img class="media-object" src="{{ asset('tproject/images/blog-thumb-2.jpg') }}" alt="blog-thumb">
                          <a href="blog-post.html" class="overlay-link small"><i class="fa fa-link"></i></a>
                        </div>
                      </div>
                      <div class="media-body">
                    ...
                    <div class="media margin-clear">
                      <div class="d-flex pr-2">
                        <div class="overlay-container">
                          <img class="media-object" src="{{ asset('tproject/images/blog-thumb-3.jpg') }}" alt="blog-thumb">
                          <a href="blog-post.html" class="overlay-link small"><i class="fa fa-link"></i></a>
                        </div>
                      </div>
                      <div class="media-body">
                    ...
                    <div class="media margin-clear">
                      <div class="d-flex pr-2">
                        <div class="overlay-container">
                          <img class="media-object" src="{{ asset('tproject/images/blog-thumb-4.jpg') }}" alt="blog-thumb">
                          <a href="blog-post.html" class="overlay-link small"><i class="fa fa-link"></i></a>
                        </div>
                      </div>
                      <div class="media-body">
                    ...
                    <div class="row grid-space-10">
                      <div class="col-4 col-lg-6">
                        <div class="overlay-container mb-10">
                          <img src="{{ asset('tproject/images/gallery-1.jpg') }}" alt="">
                      ...
                      <div class="col-4 col-lg-6">
                        <div class="overlay-container mb-10">
                          <img src="{{ asset('tproject/images/gallery-2.jpg') }}" alt="">
                          <a href="portfolio-item.html" class="overlay-link small">
                            <i class="fa fa-link"></i>
                          </a>
                        </div>
                      ...
                      <div class="col-4 col-lg-6">
                        <div class="overlay-container mb-10">
                          <img src="{{ asset('tproject/images/gallery-3.jpg') }}" alt="">
                          <a href="portfolio-item.html" class="overlay-link small">
                            <i class="fa fa-link"></i>
                          </a>
                        </div>
                      ...
                      <div class="col-4 col-lg-6">
                        <div class="overlay-container mb-10">
                          <img src="{{ asset('tproject/images/gallery-4.jpg') }}" alt="">
                          <a href="portfolio-item.html" class="overlay-link small">
                            <i class="fa fa-link"></i>
                          </a>
                        </div>
                      ...
                      <div class="col-4 col-lg-6">
                        <div class="overlay-container mb-10">
                          <img src="{{ asset('tproject/images/gallery-5.jpg') }}" alt="">
                          <a href="portfolio-item.html" class="overlay-link small">
                            <i class="fa fa-link"></i>
                          </a>
                        </div>
                      ...
                      <div class="col-4 col-lg-6">
                        <div class="overlay-container mb-10">
                          <img src="{{ asset('tproject/images/gallery-6.jpg') }}" alt="">
                          <a href="portfolio-item.html" class="overlay-link small">
                            <i class="fa fa-link"></i>
                          </a>
                        </div>
